...
export default GaussKrueger5FormatFactoryFormatFactory;

function GaussKrueger5FormatFactoryFormatFactory() {
    return {
        createInstance: function () {
            ...
            return new Format({
                ...
                name: "DHDN Gauß-Krüger 5",
                conversionInfo: {
                    // Define a convert function
                    // Point -> Position
                    convert(point) {
                        let returnPoint = project(point, {wkid: 31469});
