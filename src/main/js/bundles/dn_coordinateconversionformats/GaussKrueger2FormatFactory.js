...
export default GaussKrueger2FormatFactoryFormatFactory;

function GaussKrueger2FormatFactoryFormatFactory() {
    return {
        createInstance: function () {
            ...
            return new Format({
                ...
                name: "DHDN Gauß-Krüger 2",
                conversionInfo: {
                    // Define a convert function
                    // Point -> Position
                    convert(point) {
                        let returnPoint = project(point, {wkid: 31466});
