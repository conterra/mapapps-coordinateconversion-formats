...
export default GaussKrueger4FormatFactoryFormatFactory;

function GaussKrueger4FormatFactoryFormatFactory() {
    return {
        createInstance: function () {
            ...
            return new Format({
                ...
                name: "DHDN Gauß-Krüger 4",
                conversionInfo: {
                    // Define a convert function
                    // Point -> Position
                    convert(point) {
                        let returnPoint = project(point, {wkid: 31468});
