...
export default GaussKrueger3FormatFactoryFormatFactory;

function GaussKrueger3FormatFactoryFormatFactory() {
    return {
        createInstance: function () {
            ...
            return new Format({
                ...
                name: "DHDN Gauß-Krüger 3",
                conversionInfo: {
                    // Define a convert function
                    // Point -> Position
                    convert(point) {
                        let returnPoint = project(point, {wkid: 31467});
